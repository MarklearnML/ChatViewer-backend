...
public interface ArticleService extends IService<Article> {
     ...
     * @return
     */
    Page<ArticleDto> pageWithAuthor(@RequestParam int page, @RequestParam int pageSize, Long categoryId, String search);
     ...
     * @return
     */
    List<String> searchCompletion(String prefix);
}
